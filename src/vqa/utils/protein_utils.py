...
def plot_probs_with_energy(probs, num_qubits, H_cost, ground_states_i, new_fig = True, save = False, name = '', threshhold = 0.01):
	'''
...
def get_energies_index_states(H_cost):
	...
	energy_list = []
	matrix = sparse_hamiltonian(H_cost)
...
def get_annealing_params(annealing_time, p, linear = True, cosine = False):
	'''
